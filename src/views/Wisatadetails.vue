              ...
              <MDBTabPane tabId="ex1-2">
                ...
                <MDBRow class="d-flex justify-content-between">
                  <MDBCol class="text-start">
                    <h6 v-if="review_list != null">All Review ({{review_list.length}})</h6>
                  </MDBCol>
                ...
                <MDBCol v-for ="review in review_list" :key="review._id">
                  <MDBRow>
                    ...
                    <MDBCol md="2">
                      <MDBCol>
                        <p class="mb-0 ms-2" style="font-weight: 500">{{review.id_user.name}}</p>
                      </MDBCol>
                      <MDBCol>
                        <p
                          class="mb-0 ms-2"
                ...
                >
                  <MDBIcon icon="star" iconStyle="fas" /> Remove Review
                </MDBBtn>
                        </p>
                      </MDBCol>
                    </MDBCol>
                  ...
                  <MDBRow>
                    <MDBCol md="1" class="d-flex justify-content-center ps-3">
                      ...
                      >
                        <div class="sc-1q7bklc-6 liCXOR">
                          <div class="sc-1q7bklc-5 kHxpSk">
                            <div class="sc-1q7bklc-1 cILgox">{{review.rating}}</div>
                            <div class="sc-1q7bklc-2 pxJGx">
                              <i class="sc-rbbb40-1 iFnyeo" color="#FFFFFF"
                                ><svg
                                  xmlns="http://www.w3.org/2000/svg"
...
export default {
  ...
  setup() {
    ...
    let uri_review = process.env.VUE_APP_ROOT_API + "wisata/" + route.params.slug + "/review";
    app.appContext.config.globalProperties.$http.get(uri_review).then((response) => {
    ...
    const activeTabId1 = ref("ex1-1");
      ...
      return app.appContext.config.globalProperties.$http.get(uri_review).then((response) => {
    ...
    if(review_content.rating == null){
      ...
      let uri_addReview = process.env.VUE_APP_ROOT_API + "wisata/" + route.params.slug + "/review";
    app.appContext.config.globalProperties.$http
  ...
  if (result.isConfirmed) {
    ...
    let uri_deleteReview = process.env.VUE_APP_ROOT_API + "wisata/" + route.params.slug + "/review";
    app.appContext.config.globalProperties.$http.delete(uri_deleteReview,config).then(()=> {
